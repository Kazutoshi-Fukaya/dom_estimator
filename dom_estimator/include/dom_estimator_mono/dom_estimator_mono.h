#ifndef DOM_ESTIMATOR_MONO_H_
#define DOM_ESTIMATOR_MONO_H_
...
#include "multi_localizer_msgs/SimpleObjectMap.h"
...
private:
    ...
    // subscriber
    ros::Subscriber ops_with_id_sub_;
    
    // database
    // Database* database_;
    SimpleDatabase* database_;
